...
@InputType()
class UserProgressCreateNestedManyWithoutCoursesInput {
...
export { UserProgressCreateNestedManyWithoutCoursesInput as UserProgressCreateNestedManyWithoutCoursesInput };
